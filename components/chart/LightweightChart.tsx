...
const chartOptions: import("lightweight-charts").DeepPartial<
  import("lightweight-charts").TimeChartOptions
> = {
  layout: {
    textColor: "black",
    background: {
      type: "solid",
      color: "white",
    } as import("lightweight-charts").DeepPartial<
      import("lightweight-charts").SolidColor
    >,
  },
  height: 200,
}
...
).addLineSeries({ color: intervalColors["1D"] })
