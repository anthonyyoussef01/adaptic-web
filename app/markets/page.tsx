...
export default async function Home({
  ...
  return (
    <div className="flex flex-col gap-y-4 py-2 md:gap-x-4">
      <div className="flex flex-col gap-4 lg:flex-row">
        <div className="w-full lg:w-1/2">
          <Card className="relative flex h-full min-h-[15rem] flex-col justify-between overflow-hidden">
            <CardHeader>
              <CardTitle className="z-30 w-fit rounded-full px-4 py-2 font-medium dark:bg-neutral-100/5">
                The markets are{" "}
      ...
      <div>
        <Card className="space-y-6 p-4 lg:p-6">
          <CardTitle>Markets</CardTitle>
          <CardContent className="flex flex-col gap-y-4 p-0 lg:flex-row lg:gap-x-4">
            <div className="w-full lg:w-1/2">
              <Suspense fallback={<div>Loading...</div>}>
